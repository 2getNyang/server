...
public class OAuth2WithdrawNaverService {
    ...
    public void unlinkNaver(String snsAccessToken) {
        ...
        params.add("access_token", snsAccessToken);
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            //  User 조회 및 deletedAt timestamp 처리
